...
namespace Persistence.Migrations
{
    ...
    [Migration("20200123123639_seedUserTableWithSuperAdminUserAndMakeOfferPriceColTypeMoney")]
    partial class seedUserTableWithSuperAdminUserAndMakeOfferPriceColTypeMoney
    {
            ...
            modelBuilder.Entity("Domain.AdminPanel.Web.Categories.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CraetedAt")
                        ...
                        .HasDefaultValue(new DateTime(2020, 1, 23, 14, 36, 39, 524, DateTimeKind.Local).AddTicks(2211));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 23, 14, 36, 39, 528, DateTimeKind.Local).AddTicks(7201));
            ...
            modelBuilder.Entity("Domain.AdminPanel.Web.Items.Item", b =>
                {
                    ...
                    b.Property<DateTime>("CraetedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 23, 14, 36, 39, 534, DateTimeKind.Local).AddTicks(2593));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 23, 14, 36, 39, 534, DateTimeKind.Local).AddTicks(3008));
            ...
            modelBuilder.Entity("Domain.AdminPanel.Web.Offers.Offer", b =>
                {
                    ...
                    b.Property<DateTime>("CraetedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 23, 14, 36, 39, 538, DateTimeKind.Local).AddTicks(8117));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 23, 14, 36, 39, 538, DateTimeKind.Local).AddTicks(8466));
            ...
            modelBuilder.Entity("Domain.AdminPanel.Web.Subcategories.SubCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CraetedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 23, 14, 36, 39, 540, DateTimeKind.Local).AddTicks(6053));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 23, 14, 36, 39, 540, DateTimeKind.Local).AddTicks(6546));
