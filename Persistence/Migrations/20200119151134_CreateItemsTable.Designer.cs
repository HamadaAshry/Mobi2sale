...
namespace Persistence.Migrations
{
    ...
    [Migration("20200119151134_CreateItemsTable")]
            ...
            modelBuilder.Entity("Domain.AdminPanel.Web.Categories.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CraetedAt")
                        ...
                        .HasDefaultValue(new DateTime(2020, 1, 19, 17, 11, 34, 179, DateTimeKind.Local).AddTicks(3132));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 19, 17, 11, 34, 186, DateTimeKind.Local).AddTicks(2618));
            ...
            modelBuilder.Entity("Domain.AdminPanel.Web.Items.Item", b =>
                {
                    ...
                    b.Property<DateTime>("CraetedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 19, 17, 11, 34, 201, DateTimeKind.Local).AddTicks(1435));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 19, 17, 11, 34, 201, DateTimeKind.Local).AddTicks(1985));
            ...
            modelBuilder.Entity("Domain.AdminPanel.Web.Subcategories.SubCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CraetedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 19, 17, 11, 34, 205, DateTimeKind.Local).AddTicks(7427));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 19, 17, 11, 34, 205, DateTimeKind.Local).AddTicks(7866));
