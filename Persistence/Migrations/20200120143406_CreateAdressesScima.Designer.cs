...
namespace Persistence.Migrations
{
    ...
    [Migration("20200120143406_CreateAdressesScima")]
    partial class CreateAdressesScima
    {
            ...
            modelBuilder.Entity("Domain.AdminPanel.Web.Categories.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CraetedAt")
                        ...
                        .HasDefaultValue(new DateTime(2020, 1, 20, 16, 34, 6, 396, DateTimeKind.Local).AddTicks(1423));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 20, 16, 34, 6, 401, DateTimeKind.Local).AddTicks(2956));
            ...
            modelBuilder.Entity("Domain.AdminPanel.Web.Items.Item", b =>
                {
                    ...
                    b.Property<DateTime>("CraetedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 20, 16, 34, 6, 406, DateTimeKind.Local).AddTicks(7812));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 20, 16, 34, 6, 406, DateTimeKind.Local).AddTicks(8194));
            ...
            modelBuilder.Entity("Domain.AdminPanel.Web.Subcategories.SubCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CraetedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 20, 16, 34, 6, 410, DateTimeKind.Local).AddTicks(5288));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 20, 16, 34, 6, 410, DateTimeKind.Local).AddTicks(5657));
