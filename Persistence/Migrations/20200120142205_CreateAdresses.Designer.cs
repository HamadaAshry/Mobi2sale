...
namespace Persistence.Migrations
{
    ...
    [Migration("20200120142205_CreateAdresses")]
    partial class CreateAdresses
    {
            ...
            modelBuilder.Entity("Domain.AdminPanel.Web.Categories.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CraetedAt")
                        ...
                        .HasDefaultValue(new DateTime(2020, 1, 20, 16, 22, 5, 394, DateTimeKind.Local).AddTicks(9806));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 20, 16, 22, 5, 400, DateTimeKind.Local).AddTicks(2892));
            ...
            modelBuilder.Entity("Domain.AdminPanel.Web.Items.Item", b =>
                {
                    ...
                    b.Property<DateTime>("CraetedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 20, 16, 22, 5, 406, DateTimeKind.Local).AddTicks(5448));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 20, 16, 22, 5, 406, DateTimeKind.Local).AddTicks(5910));
            ...
            modelBuilder.Entity("Domain.AdminPanel.Web.Subcategories.SubCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CraetedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 20, 16, 22, 5, 410, DateTimeKind.Local).AddTicks(6648));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 20, 16, 22, 5, 410, DateTimeKind.Local).AddTicks(7129));
