...
namespace Persistence.Migrations
{
    ...
    [Migration("20200123121144_seedUserTableWitAdminUser")]
    partial class seedUserTableWitAdminUser
    {
            ...
            modelBuilder.Entity("Domain.AdminPanel.Web.Categories.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CraetedAt")
                        ...
                        .HasDefaultValue(new DateTime(2020, 1, 23, 14, 11, 44, 183, DateTimeKind.Local).AddTicks(631));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 23, 14, 11, 44, 192, DateTimeKind.Local).AddTicks(783));
            ...
            modelBuilder.Entity("Domain.AdminPanel.Web.Items.Item", b =>
                {
                    ...
                    b.Property<DateTime>("CraetedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 23, 14, 11, 44, 201, DateTimeKind.Local).AddTicks(4642));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 23, 14, 11, 44, 201, DateTimeKind.Local).AddTicks(5188));
            ...
            modelBuilder.Entity("Domain.AdminPanel.Web.Offers.Offer", b =>
                {
                    ...
                    b.Property<DateTime>("CraetedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 23, 14, 11, 44, 208, DateTimeKind.Local).AddTicks(6875));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 23, 14, 11, 44, 208, DateTimeKind.Local).AddTicks(7458));
            ...
            modelBuilder.Entity("Domain.AdminPanel.Web.Subcategories.SubCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CraetedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 23, 14, 11, 44, 211, DateTimeKind.Local).AddTicks(5989));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 23, 14, 11, 44, 211, DateTimeKind.Local).AddTicks(8063));
