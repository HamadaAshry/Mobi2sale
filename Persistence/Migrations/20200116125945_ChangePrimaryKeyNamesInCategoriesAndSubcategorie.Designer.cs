...
namespace Persistence.Migrations
{
    ...
    [Migration("20200116125945_ChangePrimaryKeyNamesInCategoriesAndSubcategorie")]
    partial class ChangePrimaryKeyNamesInCategoriesAndSubcategorie
    {
            ...
            modelBuilder.Entity("Domain.AdminPanel.Web.Categories.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CraetedAt")
                        ...
                        .HasDefaultValue(new DateTime(2020, 1, 16, 14, 59, 45, 382, DateTimeKind.Local).AddTicks(7569));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 16, 14, 59, 45, 388, DateTimeKind.Local).AddTicks(6772));
            ...
            modelBuilder.Entity("Domain.AdminPanel.Web.Subcategories.SubCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CraetedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 16, 14, 59, 45, 409, DateTimeKind.Local).AddTicks(7016));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 1, 16, 14, 59, 45, 409, DateTimeKind.Local).AddTicks(7418));
